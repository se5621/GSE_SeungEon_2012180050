...
# 10 - 적이 총알하고 충돌했을 때
    ...
    survivedtext = font.render(
        str("TIME") + " " + str(int((120000 - pygame.time.get_ticks()) / 1000 % 1200)).zfill(2), True, (0, 0, 0))
